...
相信你很难想象，其实你只要进行简单的配置，就能实现上图的界面。比如下图的 `js 对象` 就是上图的其中几个表单项的配置： ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9c62893aa6f74376911fce6bc53e1672~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp?)
